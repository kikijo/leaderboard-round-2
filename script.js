...
const participants = [
    ...
    { avatar: 'tiger', name: '', surveyStatus: 'completed' },
    { avatar: 'butterfly', name: '', surveyStatus: 'not started' },
    { avatar: 'cow', name: '', surveyStatus: 'completed' },
    { avatar: 'monkey', name: '', surveyStatus: 'completed' },
    { avatar: 'cat', name: '', surveyStatus: 'completed' },
    ...
    { avatar: 'bear', name: '', surveyStatus: 'completed' },
    { avatar: 'fox', name: '', surveyStatus: 'not started' },
    { avatar: 'unicorn', name: '', surveyStatus: 'completed' },
